                    ...
                    <form action="{{ route('register') }}" method="post">
                      @csrf
                        <div class="form-group">
                            ...
                            <input type="text" name="name" class="form-control input-style @error('name') is-invalid @enderror"  id="exampleInputName"    aria-describedby="nameHelp" placeholder="Enter Name">
                        ...
                        <div class="form-group">
                            ...
                            <input type="email" name="email" class="form-control input-style @error('email') is-invalid @enderror"  id="exampleInputEmail1"
                        ...
                        <div class="form-group">
                            ...
                            <input type="password" name="password" class="form-control input-style @error('password') is-invalid @enderror" id="exampleInputPassword1"
                        ...
                        <button type="submit" class="btn btn-primary btn-style mt-4">Register</button>
                    </form>
                </div>
            </div>
